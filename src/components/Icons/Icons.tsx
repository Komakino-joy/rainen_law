...
export const DownArrowIcon = () => (
  <span className={styles['icon-wrapper']}>
    <svg fill='#ffa500' xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 96 960 960" width="20"><path d="M480 896 160 576l56-57 224 224V256h80v487l224-224 56 57-320 320Z"/></svg>
  </span>
)

export const UpArrowIcon = () => (
  <span className={styles['icon-wrapper']}>
    <svg fill='rgb(15, 202, 87)' xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 96 960 960" width="20"><path d="M440 896V409L216 633l-56-57 320-320 320 320-56 57-224-224v487h-80Z"/></svg>
 </span>
)

export const SortIcon = () => (
  <span className={styles['icon-wrapper']}>
    <svg fill='white' xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 96 960 960" width="20"><path d="M120 816v-80h240v80H120Zm0-200v-80h480v80H120Zm0-200v-80h720v80H120Z"/></svg>
 </span>
)